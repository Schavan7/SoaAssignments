...
java.util.List<ws.Employee> result=null;
      out.write("\n");
      out.write("<html>\n");
      out.write("    <head>\n");
	...
	// TODO handle custom exceptions here
      ...
      out.write("\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t<th>ID</th>\n");
      out.write("\t\t\t\t\t<th>License Plate no</th>\n");
...
for(int i= 0; i<result.size(); i++){
      ...
      out.write("                            \n");
      out.write("                                <td>");
out.println(result.get(i).getEmployeeId());
      out.write("</td>\n");
      out.write("                        \n");
      out.write("                        <td>");
out.println(result.get(i).getFirstName());
      out.write("</td>\n");
      out.write("                        \n");
      out.write("                        </tr>");
}
